    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <div className="mt-8 border-t border-gray-300 text-center w-full">
          ...
          <a href='https://lista.havan.com.br//Convidado/ItensListaPresente/822165' target="_blank" className="w-full bg-[#183153] text-[#ffd43b] px-4 py-2 rounded mb-2 flex items-center justify-center space-x-2 p-2">
            ...
            <span>Lista de Casamento Havan</span>
          </a>
